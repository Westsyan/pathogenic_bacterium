...
var posi = ["基因组构成", "是否感染人", "是否感染动物", "是否感染植物", "传播途径", "感染剂量",
    ...
    $("#table").bootstrapTable({
        columns: [{
            ...
            formatter: function (value, row, index) {
                var de = "<a href='/chinese/admin/Virus/updateBefore?id=" + row.id + "' target='_blank'><button class='update' title='修改'><i class='fa fa-edit'></i></button></a>" +
            ...
            title:"名称",
            formatter:function (value,row,index) {
                var de = "<i><a href='/chinese/Virus/moreInfo?id="+ row.id+"' target='_blank'>" + row.name +"</a></i>";
                return de;
            }
        }] ,
