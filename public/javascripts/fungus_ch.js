    ...
    $("#table").bootstrapTable({
        columns: [{
            ...
            formatter: function (value, row, index) {
                var de = "<a href='/chinese/admin/Fungus/updateBefore?id=" + row.id + "' target='_blank'><button class='update' title='修改'><i class='fa fa-edit'></i></button></a>" +
            ...
            title:"名称",
            formatter: function (value,row,index) {
                var de = "<i><a href='/chinese/Fungus/moreInfo?id=" + row.id +"' target='_blank'>" + row.name+"</a></i>";
                return de;
            }
        }] ,
