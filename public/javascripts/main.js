...
function cpm(title) {
    var html = "    <div id=\"updateSuccess\" class=\"modal fade modal-margin\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\" aria-hidden=\"true\" style=\"margin-top: 200px;\">\n" +
        ...
        "                    <div align=\"center\">\n" +
        "                        <button type=\"button\" class=\"btn green\"   style=\"width: 100px;\"   onclick=\"sureSuccess()\"  >确定</button>\n" +
        "                    </div>\n" +
        "                </div>\n" +
        "            </div>\n" +
        "        </div>\n" +
...
function error(text) {
    var html = "    <div id=\"error\" class=\"modal fade modal-margin\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\" aria-hidden=\"true\" style=\"margin-top: 200px;\">\n" +
        "        <div class=\"modal-dialog\" style=\"width: 400px;\">\n" +
        "            <div class=\"modal-content\">\n" +
        "                <div class=\"modal-header bg-primary\">\n" +
        "                    <h4 class=\"modal-title\" align=\"center\" id=\"errorTitle\">\n" +
        "                        <span id=\"deleteTitle\" style=\"font-weight: bold;font-size: 25px\"> Warning</span>\n" +
        "                    </h4>\n" +
        "                </div>\n" +
        "                <div class=\"row-fluid\" align=\"center\" style='height: 150px;' >\n" +
        "<div><img src=\"/assets/images/warning.png\"></div>\n" +
        "                    <div id=\"successIcon\">\n" +
        "                        <span id=\"errorText\" style='font-size: 20px;' >"+ text +"</span>\n" +
        "                    </div>\n" +
        "                </div>\n" +
        "                <div class=\"modal-footer bg-info\">\n" +
        "                    <div align=\"center\">\n" +
        "                        <button type=\"button\" class=\"btn green\"   style=\"width: 100px;\" data-dismiss=\"modal\"   >确定</button>\n" +
        "                    </div>\n" +
        "                </div>\n" +
        "            </div>\n" +
        "        </div>\n" +
