...
var risk = ["中国(2006)", "美国 NIH (2016)", "美国 BMBL (2009)",
    "澳大利亚/新西兰 (2010)", "比利时 (2008)", "加拿大 (2015)",
    "欧盟 (2000)", "德国 (2013)", "日本", "新加坡", "瑞士",
    "英国 (2013)", "Select Agent CDC", "Select Agent USDA"];
...
var array = ["目","科","属","种",
    ...
    "预后/死亡率","有效治疗药物","疫苗","中国 (2006)","美国 NIH (2016)","美国 BMBL (2009)",
    "澳大利亚/新西兰 (2010)",	"比利时 (2008)",	"加拿大 (2015)",
    "欧盟 (2000)","德国 (2013)","日本","新加坡",	"瑞士",
    "英国 (2013)","Select Agent CDC","Select Agent USDA"];
    ...
    $("#table").bootstrapTable({
        columns: [{
            ...
            formatter: function (value, row, index) {
                var de = "<a href='/chinese/admin/Parasite/updateBefore?id=" + row.id + "' target='_blank'><button class='update' title='修改'><i class='fa fa-edit'></i></button></a>" +
            ...
            title:"名称",
            formatter: function (value,row,index) {
                var de = "<i><a href='/chinese/Parasite/moreInfo?id=" + row.id +"' target='_blank'>" + row.name+"</a></i>";
                return de;
            }
        }] ,
...
var hiddenArray = ["order", "family" , "genus" ,"isAnimal",
    "isPlant", "infectiveDose" , "survivalCondition", "deathRate", "isVaccine" , "usabmblRisk" , "australiaNewzealandRisk",
    "belgiumRisk" , "canadaRisk" , "euRisk", "germanyRisk" , "japanRisk", "singaporeRisk" ,
    "switzerlandRisk" , "ukRisk", "selectAgentCdc" , "selectAgentUsda"];
...
function loadParasite() {
    ...
    $.ajax({
        url : "/english/Parasite/getAllParasite",
        type: "get",
        dataType : "json",
